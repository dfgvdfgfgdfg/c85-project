...
function up() {
    if (img_y >= 0) {
        img_y = img_y - 10;
		console.log('when up is pressed,x='+ img_x+'and y='+ img_y);
        upload_1();
        upload_2();
    }
}
...
function down() {
    if (img_y <= 500) {
        img_y = img_y + 10;
		console.log('when down is pressed,x='+ img_x+'and y='+ img_y);
        upload_1();
        upload_2();
    }
}
...
function left() {
    if (img_x >= 0) {
        img_x = img_x - 10;
		console.log('when left is pressed,x='+ img_x+'and y='+ img_y);
        upload_1();
        upload_2();
    }
}
...
function right() {
    if (img_x <= 700) {
        img_x = img_x + 10;
		console.log('when right is pressed,x='+ img_x+'and y='+ img_y);
